    ...
    ?>
        <tr style="background-color: <?= $background ?>">
            ...
            <td class="text-center">
                <a href="<?= site_url() . 'transaksi' . '/cetak_pdf_struk/' . @$row['transhotel_id'] .  '/' . @$row['detail_id'] ?>" target="_blank" class="btn btn-xs btn-table btn-warning"><i class="fa fa-fw fa-print"></i> </a>
