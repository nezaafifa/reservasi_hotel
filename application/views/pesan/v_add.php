    ...
    <section class="content">
      ...
      <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <?php 
            echo form_open_multipart('pesan/add');
            ?>
            <!-- form start -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="tgl_checkin" name="tgl_checkin" placeholder="Isi Tanggal Checkin" required>
                </div>
                <div class="form-group">
                  <label for="tgl_checkout">Tanggal Checkout</label>
                  <input type="date" class="form-control" id="tgl_checkout" name="tgl_checkout" placeholder="Isi Tanggal Checkout" required>
                </div>
              </div>
              <!-- /.box-body -->
